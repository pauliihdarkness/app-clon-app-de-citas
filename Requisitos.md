...
- [x] Modal de Intereses con categorías y emojis (máx 8)
- [x] Selector de ubicación (país, provincia, ciudad)
- [x] Gestión de intereses (máx 8)
- [x] Crop de imágenes antes de subir con react-easy-crop
- [x] Optimización automática de imágenes en Cloudinary
- [x] Compresión automática (máx 1MB, 1500px)
- [x] Actualización inmediata de fotos en Firestore
- [ ] Configurar preferencias de búsqueda
- [ ] Verificación de perfil (badge azul)

### Visualización
- [x] Ver perfil propio
- [x] Carrusel de fotos con gestos táctiles (swipe)
...
- [x] Navegación desde perfil a configuración
- [x] Botón de cerrar sesión en Settings
- [x] Secciones: Cuenta, Preferencias, Acerca de
...
- [ ] Feed de usuarios con sistema de swipe cards
- [ ] Algoritmo de recomendación básico
- [ ] Filtros por género, edad, distancia
- [ ] Swipe derecha (like) / izquierda (dislike)
- [ ] Animaciones de swipe
- [ ] Indicador de usuarios disponibles
- [ ] Recarga de usuarios cuando se acaban
...
- [ ] Registrar likes en Firestore
- [ ] Registrar dislikes en Firestore
- [ ] Detectar matches mutuos automáticamente
